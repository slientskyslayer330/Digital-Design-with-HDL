...
HD_PWD='D:/VHDL/Digital-Design-with-HDL/clk_div/clk_div.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cld_div.vds -m64 -mode batch -messageDb vivado.pb -notrace -source cld_div.tcl
