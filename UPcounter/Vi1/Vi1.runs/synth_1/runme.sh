...
HD_PWD='D:/VHDL/Digital-Design-with-HDL/UPcounter/Vi1/Vi1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sim.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sim.tcl
