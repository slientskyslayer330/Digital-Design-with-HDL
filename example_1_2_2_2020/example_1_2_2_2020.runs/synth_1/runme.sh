...
HD_PWD='D:/VHDL/Digital-Design-with-HDL/example_1_2_2_2020/example_1_2_2_2020.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log example_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source example_1.tcl
