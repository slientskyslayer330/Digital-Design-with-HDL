...
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { p[2] }]; #IO_L13N_T2_MRCC_14 Sch=sw[2]
...
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { sum  }]; #IO_L24P_T3_RS1_15 Sch=led[0]
