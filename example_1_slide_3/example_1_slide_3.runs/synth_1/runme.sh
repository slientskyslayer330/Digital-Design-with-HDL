...
HD_PWD='D:/VHDL/Digital-Design-with-HDL/example_1_slide_3/example_1_slide_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eg2.vds -m64 -mode batch -messageDb vivado.pb -notrace -source eg2.tcl
